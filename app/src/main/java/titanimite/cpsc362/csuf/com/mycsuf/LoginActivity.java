...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private JSONArray SAVED_EMAILS;
...
//        session.setNewActivityContext(getApplicationContext());
        ...
        mSignUpTextView = (TextView) findViewById(R.id.account_sign_up_link);
...
//                intent.putExtra("session", session);
        ...
        Log.i("Saved emails: ", SAVED_EMAILS.toString());
    }
    ...
    private void loadSavedEmails() {
        ...
        SAVED_EMAILS = new JSONArray();
        try {
            SAVED_EMAILS = new JSONArray(emails);
            Log.i("LOGIN_ACTIVITY", SAVED_EMAILS.toString());
